    ...
    <div className="flex md:flex-col md:h-full gap-2 bg-primary-1 p-2">
      <div className="flex flex-col gap-2 flex-1">
        ...
        <Button
          ...
          className={`${tool === "pencil" && "!border-primary-light bg-primary-2"} border border-transparent  w-full `}
        >
          <PencilIcon
            width={20}
            height={20}
        ...
        <Button
          ...
          className={`${tool === "eraser" && "!border-primary-light bg-primary-2"} border border-transparent  w-full`}
        >
          <EraserIcon
            width={20}
            height={20}
